...
test.describe('Teknisi - Login Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/login');
  });

  test('should login successfully with valid teknisi credentials', async ({ page }) => {
    // Fill login form
    ...
    await expect(page.locator('text=/teknisi/i').first()).toBeVisible({ timeout: 10000 });
  });
