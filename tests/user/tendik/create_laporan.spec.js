...
test.describe('Fitur Laporan - tendik', () => {
  const base = 'https://reportaction.dbsnetwork.my.id';
  const loginUrl = `${base}/login`;

  test('Tendik dapat membuat laporan kerusakan', async ({ page }) => {
    ...
    await page.fill('input[name="laporan_judul"]', 'Testing laporan tendik');
